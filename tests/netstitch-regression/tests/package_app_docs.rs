...
fn module_sdk_contract_docs_use_current_host_commands() {
    ...
    for required in [
        ...
        "ui_entity_showcase_rust.entity.nested_subpanel.title",
        "ui_entity_showcase_cpp.entity.nested_subpanel.title",
        "`nested_subpanel`",
        "two-layer `nested_subpanel`",
