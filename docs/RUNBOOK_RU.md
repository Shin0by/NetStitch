...
7. Если обновлялись Module SDK examples, перед Linux smoke пересобрать `scripts\package_module_sdk_examples.ps1`, затем обновить installed showcase-модули из `docs/module-sdk/packages/*-linux-x86_64.zip` в `~/.local/share/netstitch/integrations`.
