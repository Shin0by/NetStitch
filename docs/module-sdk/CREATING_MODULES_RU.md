...
Этот документ описывает полный путь автора модуля: от папки с исходниками до installable-архива, который пользователь может положить в `integrations/`.
